export const BASE_URL = 'https://localhost:44347/api/';/* alternative url for testing on local db https://localhost:44347/api/values on live https://clickncheck.azurewebsites.net/api/ */
