export const BASE_URL = 'https://localhost:44347/api/'; /* alternative url for testing on local db 'https://localhost:44347/api/' or live db 'https://clickncheck.azurewebsites.net/api/'  */
...
export const GET_JOB_PROFILES = 'JobProfiles/GetAllJobProfiles';