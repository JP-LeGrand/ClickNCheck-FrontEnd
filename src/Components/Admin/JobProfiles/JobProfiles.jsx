...
import { BASE_URL, GET_JOB_PROFILES } from '../../../Shared/Constants';
...
class JobProfiles extends Component {
    ...
    allJobProfiles(){
        fetch(BASE_URL + GET_JOB_PROFILES, {
            method: 'GET',
                ...
                <div className="mainSection">  
                    <div className="filter">
                        <div id="heading">
                            ...
                            <label id="count"><b>10</b>/10</label>
                        </div>
                        <RadioGroup id="filter" className="radios" onClick={(event) => this.userChoice(event)}>
                            <FormControlLabel id="All" className="radio" value="All" control={<Radio disableRipple color="primary" />} label="All" />
                    ...
                    <div className="results">
                        {this.state.results==='All' || this.state.results==='Assigned' || this.state.results==='Unassigned' ? <JobProfileResults allJobProfiles={this.state.allJobProfiles} /> : <JobProfileResults />}
                    </div>
                </div>
            </div>
        );
