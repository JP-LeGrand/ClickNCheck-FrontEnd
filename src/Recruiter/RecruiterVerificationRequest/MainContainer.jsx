        ...
        return (
            <fieldset className="field1 current">
                <table className = "ImportTable">
                        ...
                        {this.state.excelRows.map((name, key) => {
                            return (
                                ...
                                <tr className="Shape" key={key.IDs} >  
                                    <td className="fieldContainer" ><input className="FieldValue" type="text" name="name" defaultValue = {name.FirstName} onChange={(event) => this.handleUserInput(event)}/></td>
                                    <td className="fieldContainer"><input className="FieldValue" type="text" name="surname" defaultValue = {name.Surname} onChange={(event) => this.handleUserInput(event)}/></td>
                                    <td className="fieldContainer"><input className="FieldValue" type="text" name="madein" defaultValue = {name.MaidenSurname} onChange={(event) => this.handleUserInput(event)}/></td>
                                    <td className="fieldContainer"><input className={this.state.fieldID} type="text" name="id" defaultValue = {name.IDorPassport} onChange={(event) => this.handleUserInput(event)}/></td>
                                    <td className="fieldContainer"><input className="FieldValue" type="text" name="dob" defaultValue = {name.Birthday} onChange={(event) => this.handleUserInput(event)}/></td>
                                    <td className="fieldContainer"><input className={this.state.fieldEmail} type="text" name="email" defaultValue = {name.Email} onChange={(event) => this.handleUserInput(event)}/></td>
                                    <td className="fieldContainer"><input className={this.state.fieldPhone} type="text" name="phone" defaultValue = {name.Phone} onChange={(event) => this.handleUserInput(event)}/></td>
                                </tr>
                            );
                        })}
                    ...
                    <button type="submit" className="btn btn-primary" disabled={!this.state.tableValid}>Sign up</button>
                </table> 
